...
const StayBox: React.FC<StayBoxProps> = ({name,distance,location,description}) => {
    return (
        <button className='relative w-[317px] h-[171px] rounded-[15px] bg-white shadow'
            style={{
            ...
            <div className='absolute bottom-[19px] left-[25px] w-[268px] h-[77px] rounded-[10px] gap-[3px] flex bg-gray-dg'>
